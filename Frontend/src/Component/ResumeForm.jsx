...
const ResumeForm = (props) => {
  ...
  return (
    <div className=" m-10 p-5 shadow-2xl gap-2  rounded-2xl sm:grid-cols-1">
       <div className="grid grid-cols-2">
      <div className="flex flex-row">
        <label className="  rounded-2xl text-xl font-serif ml-14  mb-2 mt-2">
          Title:
        </label>
        <div id="dropdownList">
          <select
            id="dropdown"
            className="border-2  ml-14 border-black p-2 bg-inherit rounded-md w-96  mb-2"
          >
      ...
      <label className="grid grid-cols-6  rounded-2xl text-xl font-serif ml-14 mb-2">
        Name:
        <input
          type="text"
          value={Name}
          className="border-2 col-span-5 border-black p-2 bg-inherit  rounded-md w-96"
          onChange={(e) => setName(e.target.value)}
        />
      </label>
      <label className="grid grid-cols-6  rounded-2xl text-xl  mb-2 font-serif ml-14">
        Email:
        <input
          type="email"
          value={email}
          ...
          <div className="grid grid-cols-1 col-span-4">
            <div className="grid grid-cols-1">
              ...
              <div id="dropdownList">
                <select
                  id="dropdown"
                  className="border-2 col-span-5 border-black p-2 bg-inherit rounded-md w-96  mb-2 "
                >
            ...
            <div className="grid grid-cols-1">
              ...
              <input
                type="text"
                value={school}
                className="border-2 border-black p-2 bg-inherit mb-2 rounded-md w-96"
            ...
            <div
              className="text-white text-center rounded-md w-96 p-2 font-bold text-xl bg-green-600"
              onClick={() => {
      ...
      <div className="grid lg:grid-cols-2 sm:grid-cols-1">
        <label className="grid grid-cols-6  rounded-2xl text-xl  mb-2 lg:ml-14 sm:-mr-80 font-serif mt-5">
          ...
          <div className="flex flex-col -ml-1 col-span-4 ">
            <div className="grid grid-cols-1">
              <label className="text-l sm:ml-5 ">Title:</label>
              <input
                type="text"
                value={ctitle}
                className="border-2 border-black p-2 bg-inherit mb-2 rounded-md w-96"
      ...
      <div className="grid lg:grid-cols-2 sm:grid-cols-1">
        <label className="grid grid-cols-6  rounded-md w-96 text-xl  mb-2 font-serif lg:ml-15 sm:ml-14 mt-5">
          Skills:
          <div className="lg:ml-24 sm:ml-12">
            <input
              type="text"
              className="border-2  border-black bg-inherit h-12 rounded-md   ml-36 w-96 sm:-ml-0"
              value={skillitem}
              onChange={(e) => {
            ...
            />
            <div
              className="text-white h-12 col-span-2 text-center rounded-md w-96 p-2 font-bold text-xl sm:-ml-0 bg-green-600 mt-2 ml-36"
              onClick={() => {
      ...
      <div className="grid lg:grid-cols-2 sm:grid-cols-1">
        <label className="grid grid-cols-6  text-xl text-black  mb-2 lg:ml-12 sm:-ml-2 font-serif">
          ...
          <div className="sm:ml-16 lg:ml-16">
            <input
              type="text"
              className="col-span-2 h-12 border-2 bg-inherit border-black rounded-md w-96 "
              value={hobbiesitem}
              onChange={(e) => {
            ...
            />
            <div
              className="text-white text-center rounded-md p-2 font-bold text-xl bg-green-600 h-12  mt-2 w-96 "
              onClick={() => {
